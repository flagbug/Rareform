...
namespace Rareform.Extensions
{
    ...
    public static class IComparableExtensions
    {
        ...
        /// </remarks>
        public static void ThrowIfGreaterThan<T, TFunc>(this IComparable<T> value, T limit,
            Expression<Func<TFunc>> parameterName)
        {
            if (parameterName == null)
                Throw.ArgumentNullException(() => parameterName);
        ...
        ///     Note that the evaluation of the parameter name at runtime is an expensive operation.
        /// </remarks>
        public static void ThrowIfLessThan<T, TFunc>(this IComparable<T> value, T limit,
            Expression<Func<TFunc>> parameterName)
        {
            if (parameterName == null)
                Throw.ArgumentNullException(() => parameterName);
